...
export const ui = {
  'zh-Hant': {
    ...
    'honey-intro-2': "熱愛TRPG，誓言要把骰子機器人娶回家。作為一隻幽靈貓，鬼點子特別多，然而是挖坑小能手，想到一齣是一齣，完美發揮出三分鐘熱度的本性，不愧是貓咪。",
    'zeroOne-intro':"（本體其實是謎之二進制代碼，然而實際內容早已超過了0與1，但你還是可以稱呼他為01。）現居台灣的普通上班人，身體素質尚佳的年輕男子，年紀輕輕卻有著阿公的靈魂。泡麵的大學室友，輾轉加入了“心結廚房”，作為一名TRPG主持人及實況主活躍中。",
    'zeroOne-intro-2':"踐行 ‘開拓’之道，樂於與不同的人建立關係，目前已成功解鎖成就 ‘我來、我見、我心結’，認識了廚房所有成員。在團體中擔任正能量大使，為大家在心結生活中帶來多一點人情味。",
